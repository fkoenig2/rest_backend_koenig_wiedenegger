...
\.
COPY backup.analysis (a_id, s_id, s_stamp, pol, nat, kal, an, dry, date_in, date_out, weight_mea, weight_nrm, weight_cur, weight_dif, density, a_flags, lane, comment, date_exported) FROM '/data/2206.dat';
...
\.
COPY backup.sample (s_id, s_stamp, name, weight_net, weight_bru, weight_tar, quantity, distance, date_crumbled, s_flags, lane, comment, date_exported) FROM '/data/2207.dat';
...
\.
COPY venlab.analysis (a_id, s_id, s_stamp, pol, nat, kal, an, glu, dry, date_in, date_out, weight_mea, weight_nrm, weight_cur, weight_dif, density, a_flags, lane, comment, date_exported) FROM '/data/2208.dat';
...
\.
COPY venlab.box (b_id, name, num_max, type, comment, date_exported) FROM '/data/2210.dat';
...
\.
COPY venlab.boxpos (b_id, bpos_id, s_id, s_stamp, date_exported) FROM '/data/2211.dat';
...
\.
COPY venlab.log (log_id, date_created, level, info, s_id, s_stamp, a_id, date_exported) FROM '/data/2212.dat';
...
\.
COPY venlab.sample (s_id, s_stamp, name, weight_net, weight_bru, weight_tar, quantity, distance, date_crumbled, s_flags, lane, comment, date_exported) FROM '/data/2214.dat';
...
\.
COPY venlab.threshold (th_id, value_min, value_max, date_changed) FROM '/data/2215.dat';
